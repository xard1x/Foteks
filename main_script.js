alert('Внимание! Сайт находится на этапе ранней разработки, поэтому текст не всегда считывается. Чаще всего проблемы возникают при обработке фото в плохом качестве или при разноцветном фоне.')
var fileUrl = '';
